...
impl<'a, L: LookupLeaf> Builder<'a, L> {
    ...
    pub fn walk<'w, 'f>(
        ...
        println!("cft = {:#x?}", cft);
        println!("slots_used = {:#x?}", slots_used);
        ...
        println!("guard_failures = {:#x?}", guard_failures);
        ...
        println!("allocation = {:#x?}", allocation);
